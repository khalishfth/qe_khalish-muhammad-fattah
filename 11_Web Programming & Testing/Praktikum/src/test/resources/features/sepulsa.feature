@Sepulsa
Feature: Sepulsa
  @LoginSepulsa @NormalPositive @LoginSepulsaSuccess
  ...
  @LoginSepulsa @NormalNegative @LoginSepulsaFailed
  ...
  @ProductSepulsa @NormalPositive @ProductSepulsaTelkomsel
  ...
  @ProductSepulsa @NormalPositive @ProductSepulsaGoPay
  ...
  @ProductSepulsa @NormalNegative @ProductNominalNotAvailable
  ...
  @PaymentSepulsa @NormalPositive @PaymentSepulsaWithGopay
  ...
  @PaymentSepulsa @NormalNegative @PaymentMethodNotSelectedYet
  Scenario: User can't checkout ShopeePay Top Up because haven't choose the payment method yet
    Given user is logged in on sepulsa with username "lhcztzfinoghjhchxj@bbitq.com" and password "5@CK9xVgz84VTn$"
    When user click on the uang elektronik button on menu
    And user click on the ShopeePay button
