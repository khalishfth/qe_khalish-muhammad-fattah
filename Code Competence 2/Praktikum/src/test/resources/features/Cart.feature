...
Feature: Cart of Fake Store API
  ...
  @FakeStoreAPI @CartsFakeStoreAPI @NormalPositive @GetAllCarts
  ...
  @FakeStoreAPI @CartsFakeStoreAPI @NormalPositive @GetCartById
  ...
  @FakeStoreAPI @CartsFakeStoreAPI @NormalPositive @AddNewCart
  ...
  @FakeStoreAPI @CartsFakeStoreAPI @NormalPositive @EditCartById
  ...
  @FakeStoreAPI @CartsFakeStoreAPI @NormalPositive @DeleteCartById
